...
def TestCustomImage(my_image):
    '''
        Still working on this. dont bother now. keep working
    '''
    global d
    ...
    size = (num_px, num_px)
    new_image = np.array(img.resize(size, Image.BICUBIC))
...
if __name__ == '__main__':
    d = model(train_set_x, train_set_y, test_set_x, test_set_y, num_iterations=5000, learning_rate=0.01,
              print_cost=True)
